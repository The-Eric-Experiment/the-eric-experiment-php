...
SERVER_ADMIN="${SERVER_ADMIN:-ericmackrodt@gmail.com}"
HTTP_SERVER_NAME="${HTTP_SERVER_NAME:-server.ericexperiment.com}"
HTTPS_SERVER_NAME="${HTTPS_SERVER_NAME:-server.ericexperiment.com}"
