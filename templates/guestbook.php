    ...
    <?php if (count($form_errors) > 0) : ?>
      <tr>
        <td align="left" colspan="2">
          <font size="2" face="Arial, Helvetica, Microsoft Sans Serif"><b>Whoops, there are some issues with the info given.</b></font>
        </td>
      </tr>
      <tr>
        <td colspan="2">
          <ul>
            <?php foreach ($form_errors as $key => $value) : ?>
              <li>
                <font size="2" face="Arial, Helvetica, Microsoft Sans Serif" color="red"><?= $value; ?></font>
              </li>
            <?php endforeach; ?>
          </ul>
        </td>
...
<?php foreach ($message_list as $key => $row) : ?>
    <font size="-1" face="Arial, Helvetica, Microsoft Sans Serif"><b><?= htmlspecialchars($row['nickname']); ?></b>&nbsp;said:</font><br>
    <?= htmlspecialchars($row['message']); ?><br>
    <font size="-2" face="Arial, Helvetica, Microsoft Sans Serif" color="#777777"><?= $this->formatDate($row['created']); ?>&nbsp;|&nbsp;From:&nbsp;<b><?= $this->getBrowserInfo($row['userAgent']); ?></b></font><br>
  <?php if (++$counter < $num_results) : ?>
    <hr width="100%" />
  <?php endif; ?>
<?php endforeach; ?>
<br>
<font face="Arial, Helvetica, Microsoft Sans Serif" size="-1">
